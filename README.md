This is a script to scrape all the publically accessible images from a chosen wewbsite and is also designed to store the metadata for each image in a JSON file in the images.
